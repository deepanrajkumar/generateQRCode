export const prettyPrint = (ob, opt) => {
  const util = {
  ...
  // Main..
  const prettyPrintThis = (obj, options) => {
    /*
    ...
    var typeDealer = {
      ...
      object: function (obj, depth, key) {
        ...
        let BQRHeader = "Bharat QR Tags";
        if (depth > 0) BQRHeader = "Bharat QR Sub Tags";
        let table = util.table([BQRHeader, null], "object"),
          isEmpty = true;
        ...
        for (let j = 0; j < keys.length; j++) {
          ...
          if (!obj.hasOwnProperty || obj.hasOwnProperty(i)) {
            ...
            try {
              ...
              table.addRow(
                [colName, typeDealer[type](item, depth + 1, i)],
                type
              );
            } catch (e) {
